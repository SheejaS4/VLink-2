...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen h-screen flex flex-col lg:flex-row bg-[#0f172a] font-sans overflow-y-auto">
      {/* Left Panel: Illustration and Info */}
      <div className="flex w-full lg:w-1/2 min-w-0 bg-[#0f172a] flex-col items-center justify-center px-0 py-6 lg:py-10 lg:px-0 order-1 lg:order-none">
        <div className="flex flex-col items-center justify-center w-full h-full">
          <div className="flex items-center gap-3 mb-6 w-full pl-6 md:pl-10 justify-start">
            <img src={logo} alt="Logo" className="h-10" />
            <h1 className="text-white text-2xl font-bold">VLink CRM</h1>
          </div>
          {/* Illustration - responsive container */}
          <div className="flex justify-center items-center w-full mb-4 lg:mb-6 lg:ml-32">
            <img src={illustration} alt="Illustration" className="w-[600px] h-[500px] object-contain mx-auto" />
          </div>
          {/* Quote */}
          <div className="text-center text-[#94a3b8] text-base leading-relaxed w-full flex flex-col items-center mt-0 lg:mt-[-28px] lg:ml-40">
      ...
      <div className="w-full flex justify-end items-stretch h-full px-0 py-0 lg:w-1/2 lg:py-0 lg:pr-0 lg:pl-0 order-2 lg:order-none">
